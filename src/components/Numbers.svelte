...
<div setting="true" class="container">
  ...
  <Button gray="true"  value="**">a<sup style="margin-inline-start: .2em">b</sup></Button>
  ...
  <Button gray="true"  value="√">&radic;</Button>
  ...
  <Button gray="true"  value="(">&lpar;</Button>
  <Button gray="true"  value=")">&rpar;</Button>
  <Button  value="%">&percnt;</Button>
  <Button  value="0">0</Button>
  <Button  value=".">&sdot;</Button>
